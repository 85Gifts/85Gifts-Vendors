        ...
        <div className="w-full h-full flex items-center justify-center relative">
          ...
          <div className="relative z-10 text-center">
            <div className="w-72 h-72 bg-white rounded-full flex items-center justify-center relative overflow-hidden shadow-2xl mb-8">
              ...
              <div className="absolute top-4 left-8 text-3xl animate-pulse opacity-70">
                🎈
              </div>
              <div className="absolute top-12 right-6 text-2xl animate-bounce delay-300 opacity-80">
                ⭐
              </div>
              <div className="absolute bottom-8 left-6 text-2xl animate-pulse delay-500 opacity-70">
                🎉
              </div>
              <div className="absolute bottom-4 right-8 text-3xl animate-bounce delay-700 opacity-80">
                💝
              </div>
