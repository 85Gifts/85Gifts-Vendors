                      ...
                      {!isOutOfStock ? (
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="rounded-full border border-gray-300 dark:border-gray-600 p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                          >
