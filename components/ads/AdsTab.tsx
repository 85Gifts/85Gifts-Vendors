    ...
    <div className="space-y-6">
      ...
      {/* <div className="bg-card rounded-xl shadow-sm border dark:border-border p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {platformMetrics.map((platform) => {
            ...
            return (
              <div key={platform.platform} className="border dark:border-border rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-muted">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{platform.activeCampaigns} active campaigns</p>
                    </div>
                  </div>
                  {platform.trend === "up" ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center text-sm pt-2 border-t dark:border-border">
      ...
      <div className="bg-card rounded-xl shadow-sm border dark:border-border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="border dark:border-border rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-muted">
            <div className="flex items-center gap-3 mb-4">
              <Search className={`w-6 h-6 ${getPlatformColor("google")}`} />
              <div>
                <h4 className="font-semibold dark:text-white">Google Ads</h4>
                <p className="text-xs text-muted-foreground">Search & Display</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
              ...
              <div className="flex justify-between items-center text-sm pt-2 border-t dark:border-border">
                <span className="text-muted-foreground font-semibold">Setup Fee</span>
                <span className="font-bold text-foreground">{nairaFormatter.format(10000)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="border dark:border-border rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-muted">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-sm pt-2 border-t dark:border-border">
                <span className="text-muted-foreground font-semibold">Setup Fee</span>
                <span className="font-bold text-foreground">{nairaFormatter.format(8000)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="border dark:border-border rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-muted">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Video & In-Feed</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
              ...
              <div className="flex justify-between items-center text-sm pt-2 border-t dark:border-border">
                <span className="text-muted-foreground font-semibold">Setup Fee</span>
                <span className="font-bold text-foreground">{nairaFormatter.format(12000)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="border dark:border-border rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-muted">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Stories & AR</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
              ...
              <div className="flex justify-between items-center text-sm pt-2 border-t dark:border-border">
                <span className="text-muted-foreground font-semibold">Setup Fee</span>
                <span className="font-bold text-foreground">{nairaFormatter.format(9000)}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-card rounded-xl shadow-sm border dark:border-border">
        ...
        {/* Filters */}
        <div className="p-6 border-b dark:border-border flex flex-col sm:flex-row gap-4">
            ...
            <table className="w-full">
              <thead className="bg-muted">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Spend / Budget</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Impressions</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Clicks</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Conversions</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">CTR</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">ROAS</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border dark:divide-border">
                ...
                return (
                  <tr 
                    key={campaign.id} 
                    className="hover:bg-muted dark:hover:bg-muted cursor-pointer transition-colors"
                    onClick={() => {
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">of {currencyFormatter.format(campaign.budget)}</div>
                        <div className="w-full bg-muted dark:bg-muted rounded-full h-1.5 mt-1">
                          <div
