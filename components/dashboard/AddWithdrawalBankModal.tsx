...
export default function AddWithdrawalBankModal({
  ...
  return (
    ...
    >
      <div
        className="bg-card rounded-xl shadow-xl max-w-md w-full mx-4"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label htmlFor="bank-name" className="block text-sm font-medium text-foreground mb-2">
              Bank name
            </label>
            <select
              id="bank-name"
              ...
              className="w-full px-4 py-2 border border-border dark:bg-muted dark:text-white rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent outline-none disabled:opacity-50"
            >
              <option value="">
          ...
          <div>
            <label htmlFor="account-number" className="block text-sm font-medium text-foreground mb-2">
              Account number
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="account-name" className="block text-sm font-medium text-foreground mb-2">
              Account name
            </label>
            <input
              type="text"
              ...
              className="w-full px-4 py-2 border border-border dark:bg-muted dark:text-white rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent outline-none disabled:opacity-50 read-only:bg-muted dark:read-only:bg-muted/50 read-only:cursor-default"
            />
            {resolveError && (
